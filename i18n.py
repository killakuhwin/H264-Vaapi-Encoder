...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "en": {
        ...
        "ctx_bulk_audio":      "Audio language (all files)",
        ...
        "ctx_flip":            "Flip",
        "ctx_flip_none":       "No Flip",
        "ctx_flip_h":          "Horizontal (mirror left–right)",
        "ctx_flip_v":          "Vertical (mirror upside-down)",
    ...
    "de": {
        ...
        "ctx_bulk_audio":      "Audiosprache (alle Dateien)",
        ...
        "ctx_flip":            "Spiegeln",
        "ctx_flip_none":       "Nicht spiegeln",
        "ctx_flip_h":          "Horizontal (links–rechts)",
        "ctx_flip_v":          "Vertikal (oben–unten)",
        "ctx_vid_bitrate":     "Video-Bitrate",
        "ctx_aud_bitrate":     "Audio-Bitrate",
